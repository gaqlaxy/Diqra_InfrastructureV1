        ...
        <div className="container mx-auto px-6 md:px-12 relative z-20">
            <div ref={contentRef} className="max-w-6xl mx-auto">
                ...
                <div className="min-h-[300px] flex flex-col justify-between">
                    <blockquote ref={quoteRef} className="font-serif text-3xl md:text-5xl lg:text-6xl leading-tight mb-12">
                    ...
                    <div ref={authorRef} className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-t border-white/10 pt-8">
                        <div>
                            <cite className="not-italic font-bold text-lg tracking-widest uppercase block mb-2 text-white">
                                {testimonials[active].author}
                            </cite>
                            <span className="text-accent-gold font-light text-sm tracking-wider">
                                {testimonials[active].role} — {testimonials[active].company}
                            </span>
                        </div>

                        <div className="flex items-center gap-6">
                            <div className="flex items-center gap-2 text-sm font-bold text-spaced text-white/50">
                            ...
                            <div className="flex gap-2">
                                <button 
                                    ...
                                    className="w-12 h-12 border border-white/20 flex items-center justify-center hover:bg-white hover:text-charcoal transition-all rounded-full group bg-transparent"
