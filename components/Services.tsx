                ...
                {servicesList.map((service) => (
                    ...
                    >
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center transition-transform duration-300 group-hover:translate-x-4">
                            <div className="lg:col-span-1 text-white/30 font-display font-bold text-2xl group-hover:text-primary transition-colors">
                                {service.id}
                            </div>
                            <div className="lg:col-span-5">
                                <h3 className="font-display font-bold text-3xl md:text-4xl mb-2 text-white group-hover:text-accent-gold transition-colors">
                                    {service.title}
                                </h3>
                            ...
                            <div className="lg:col-span-4">
                                <p className="text-white/70 leading-relaxed text-sm md:text-base border-l border-white/20 pl-6 group-hover:border-primary transition-colors">
                                    {service.description}
                                </p>
                            </div>
                            <div className="lg:col-span-2 flex justify-end">
                                <div className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center group-hover:bg-accent-gold group-hover:border-accent-gold transition-all duration-300 group-hover:rotate-45 group-hover:scale-110">
